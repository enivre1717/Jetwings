...
app.directive("resize",["$window",function(e){return{scope:{},link:function(e,i,n){console.log("resize");$("canvas").parents("div").outerWidth(),$("canvas").parents("div").outerHeight();$("#Signature").signature("changeSize")}}}]);